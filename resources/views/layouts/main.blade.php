    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
          <ul class="navbar-nav">
            <li class="nav-item active"><a href="{{route('weather.index')}}" class="nav-link">Posts</a></li>
            @auth
            <li class="nav-item active"><a href="{{route('weather.create')}}" class="nav-link">Create</a></li>
            @endauth
          </ul>
